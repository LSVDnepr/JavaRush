package tasks.quest1javasyntax.level3.task0322;

public class Solution {
    /*
    Задача: Полнометражная картина
...
4. Метод getMetreFromCentimetre должен правильно возвращать количество полных метров в centimetre.
    ...
    public static int getMetreFromCentimetre(int centimetre) {
        if (centimetre<0)throw new IllegalArgumentException("Illegal value: length cannot be negative!");
