package tasks.quest1javasyntax.level4.task0415;
...
4. Если треугольник с такими сторонами не может существовать, необходимо вывести текст: "Треугольник не существует."
    ...
    public static void main(String[] args) {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            System.out.println((a+b<=c||b+c<=a||a+c<=b)?"Треугольник не сууществует":"Треугольник существует");
