package tasks.quest1javasyntax.level4.task0426;
...
7. Если число положительное и нечетное, вывести "положительное нечетное число".
    ...
    public static void main(String[] args) {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            String result = ((a > 0) ? "положительное " : "отрицательное ").concat((a % 2 == 0) ? "четное " : "нечетное ").concat("число");
